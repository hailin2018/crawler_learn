# -*- coding: UTF-8 -*-
"""
转载自：https://www.liaoxuefeng.com/discuss/969955749132672/1259954149260800

实现功能：自己实现，代码有点糙，大家互相分享学习。
多核版知乎爬虫（任意问题下的所有图片）： 1个进程分析图片地址； 2个进程8线程下载图片； 1个进程4线程解决第一次下载失败的图片；
主进程的主线程实现程序监听，判断是否终止系统，优雅退出程序！哈哈 需要在F盘新建一个img文件夹（可自己修改）
"""
